...
export const WEBSITE_SHADOW_TOKENS = {
  soft3d: "0 20px 48px -34px rgba(46,42,38,0.28)",
  card3d: "0 24px 58px -44px rgba(46,42,38,0.3)",
  panel3d: "0 28px 66px -42px rgba(46,42,38,0.28)",
...
export const WEBSITE_STYLE_CLASSES = {
  ...
  shadow: {
    soft3d: "shadow-[0_20px_48px_-34px_rgba(46,42,38,0.28)]",
    card3d: "shadow-[0_24px_58px_-44px_rgba(46,42,38,0.3)]",
    panel3d: "shadow-[0_28px_66px_-42px_rgba(46,42,38,0.28)]",
