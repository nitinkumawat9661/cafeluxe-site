...
export default function BookDemoForm() {
  ...
  const modal = open ? (
    <div
      className="fixed inset-0 z-[9999] overflow-y-auto bg-black/75 p-4 backdrop-blur-sm"
      role="dialog"
      aria-modal="true"
    ...
    >
      <div className="mx-auto flex min-h-full max-w-xl items-center py-8">
        <form
          ...
          className="w-full rounded-[2rem] border border-[#D9B86A]/30 bg-[#080604] p-6 text-[#F7EFE0] shadow-2xl"
        >
          <div className="flex justify-between gap-4">
            <div><p className="text-xs font-black uppercase tracking-[.28em] text-[#D9B86A]">CafeLuxe demo</p><h2 id="demo-form-title" className="mt-2 font-serif text-3xl text-[#E7D3A1]">Request a Demo</h2></div>
