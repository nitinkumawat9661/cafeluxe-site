...
export default function QrOrderingExperience({
  ...
  const panelGradient = isLightTheme
    ? `linear-gradient(165deg, rgba(255,230,230,0.98) 0%, ${PALETTE_SURFACE} 64%, rgba(89,0,28,0.18) 100%)`
    : `linear-gradient(165deg, ${PALETTE_SECONDARY} 0%, ${PALETTE_TEXT} 100%)`;
  const sectionGradient = isLightTheme
    ? `linear-gradient(160deg, rgba(255,230,230,0.98) 0%, ${PALETTE_SURFACE} 68%, rgba(89,0,28,0.16) 100%)`
    : `linear-gradient(160deg, ${PALETTE_SECONDARY} 0%, ${PALETTE_TEXT} 100%)`;
  const cardGradient = isLightTheme
    ? `linear-gradient(168deg, rgba(255,230,230,0.98) 0%, ${PALETTE_SURFACE} 72%, rgba(89,0,28,0.16) 100%)`
    : `linear-gradient(168deg, ${PALETTE_SECONDARY} 0%, ${PALETTE_TEXT} 100%)`;
  const sheetGradient = isLightTheme
    ? `linear-gradient(176deg, rgba(255,230,230,0.99) 0%, ${PALETTE_SURFACE} 68%, rgba(89,0,28,0.16) 100%)`
    : `linear-gradient(176deg, ${PALETTE_SECONDARY} 0%, ${PALETTE_TEXT} 100%)`;
  const bottomBarGradient = isLightTheme
    ? `linear-gradient(170deg, rgba(255,230,230,0.98) 0%, ${PALETTE_SURFACE} 68%, rgba(89,0,28,0.16) 100%)`
    : `linear-gradient(170deg, ${PALETTE_SECONDARY} 0%, ${PALETTE_TEXT} 100%)`;
  const overlayShade = isLightTheme ? "rgba(13,18,22,0.2)" : "rgba(0, 0, 0, 0.72)";
        ...
        <div
          ...
          style={{
            backgroundImage: isLightTheme
              ? `linear-gradient(180deg, rgba(255,230,230,0.62) 0%, rgba(255,230,230,0.97) 92%), url(${heroImageUrl})`
              : `linear-gradient(180deg, rgba(13,18,22,0.2) 0%, rgba(24,22,20,0.94) 92%), url(${heroImageUrl})`,
      ...
      <div
        ...
        style={{
          background: isLightTheme
            ? "linear-gradient(140deg, rgba(89,0,28,0.14) 0%, rgba(255,230,230,0) 38%, rgba(13,18,22,0.08) 100%)"
            : "linear-gradient(140deg, rgba(89,0,28,0.08) 0%, rgba(255,230,230,0) 38%, rgba(13,18,22,0.24) 100%)",
        }}
      />
      <div
      ...
      <div className="relative mx-auto flex w-full max-w-5xl flex-col px-4 pb-44 pt-5 sm:px-6 sm:pb-36">
        <header
          ...
          style={{
            ...
            ...(isLightTheme
              ? {
                  boxShadow: `0 28px 66px -42px rgba(13,18,22,0.28), 0 0 0 1px ${withAlpha(LUXURY_GOLD, 0.2)} inset`,
                }
              : null),
          }}
        >
        ...
        <section className="sticky top-[98px] z-10 mb-4 -mx-1 overflow-x-auto px-1">
          <div
            className="inline-flex min-w-full gap-2 rounded-2xl border p-1.5 shadow-[0_20px_48px_-34px_rgba(13,18,22,0.28)] backdrop-blur"
            style={{
              borderColor: withAlpha(WARM_HIGHLIGHT, 0.22),
              background: sectionGradient,
            }}
          ...
          >
            ...
            <div className="grid grid-cols-1 gap-2.5 sm:grid-cols-2">
              {offersToday.map((offer) => (
                <article
                  key={offer.id}
                  className="rounded-2xl border px-3.5 py-3.5 shadow-[0_20px_48px_-34px_rgba(13,18,22,0.24)]"
                  style={{
        ...
        {visibleItems.length === 0 ? (
          <section
            className={clsx(
              ...
              secondaryTextClass,
              isLightTheme ? "border-[#C1C1BD] bg-[#FFE6E6]" : "border-zinc-800/30 bg-white/10",
            )}
          >
            {menuItems.length === 0
              ...
              return (
                ...
                >
                  <div
                    ...
                    style={{
                      background: isLightTheme
                        ? "linear-gradient(135deg, rgba(255,230,230,0.96) 0%, rgba(89,0,28,0.28) 100%)"
                  ...
                  >
                    ...
                    <div
                      ...
                      style={{
                        background: isLightTheme
                          ? "linear-gradient(180deg, rgba(255,230,230,0.04) 0%, rgba(13,18,22,0.22) 100%)"
                          : "linear-gradient(180deg, rgba(13,18,22,0.08) 0%, rgba(17,24,39,0.86) 100%)",
                      }}
                    />
                    <div
                      ...
                      {!item.isAvailable && quantity === 0 ? (
                        <button
                          ...
                          className={clsx(
                            ...
                            isLightTheme
                              ? "border-[#C1C1BD] bg-[#C1C1BD] text-brand-dark/60"
                        ...
                        >
                          <button
                            ...
                            className={clsx(
                              ...
                              contentTextClass,
                              isLightTheme ? "hover:bg-[#C1C1BD]" : "hover:bg-zinc-800",
                            )}
            ...
            >
              ...
              <span
                className={clsx(
                  ...
                  isLightTheme ? "bg-[#C1C1BD] text-brand-dark" : "bg-black/20",
                )}
              >
            ...
            <div className="flex h-full flex-col">
              <div
                className={clsx(
                  ...
                  isLightTheme ? "border-[#C1C1BD]" : "border-zinc-800/90",
                )}
              >
                ...
                {tableOrders.length === 0 ? (
                  <div
                    className={clsx(
                      ...
                      isLightTheme
                        ? "border-[#C1C1BD] bg-[#FFE6E6] text-brand-dark/75"
                  ...
                  <>
                    <div
                      className={clsx(
                        ...
                        isLightTheme ? "bg-[#FFE6E6]" : "bg-zinc-900/70",
                      )}
                      ...
                      >
                        ...
                        <div
                          className={clsx(
                            ...
                            isLightTheme ? "border-[#C1C1BD]" : "border-zinc-800",
                          )}
                        >
                        ...
                        {currentBillInstructions ? (
                          <div
                            className={clsx(
                              ...
                              isLightTheme
                                ? "border-[#C1C1BD] bg-[#FFE6E6] text-brand-dark/80"
                                : "border-zinc-800 bg-zinc-900/70 text-zinc-300",
                            )}
                          >
                        ...
                        {applicableBillOffers.length > 0 ? (
                          <div
                            className={clsx(
                              ...
                              isLightTheme
                                ? "border-[#C1C1BD] bg-[#FFE6E6] text-brand-dark/85"
                                : "border-zinc-800 bg-zinc-900/70 text-zinc-300",
                            )}
                          >
                        ...
                        >
                          ...
                          <button
                            ...
                            className={clsx(
                              ...
                              isLightTheme
                                ? "border-[#C1C1BD] bg-white text-brand-dark hover:bg-[#FFE6E6]"
                          ...
                          <div className="mt-2 flex flex-wrap gap-2">
                            <button
                              ...
                              className={clsx(
                                ...
                                isLightTheme
                                  ? "border-[#C1C1BD] bg-white/90 text-brand-dark hover:bg-[#FFE6E6]"
          ...
          >
            <div className={clsx("flex flex-col", isStandaloneCartRoute ? "h-auto" : "h-full")}>
              <div
                ...
                style={{
                  background: isLightTheme
                    ? "linear-gradient(180deg, rgba(255,230,230,0.97) 0%, rgba(193,193,189,0.9) 100%)"
                ...
                >
                  ...
                  <textarea
                    ...
                    className={clsx(
                      ...
                      isLightTheme
                        ? "border-[#C1C1BD] bg-white text-brand-dark placeholder:text-brand-dark/45 focus:border-[#59001C]"
        ...
        >
          ...
          <aside
            className={clsx(
              ...
              isLightTheme
                ? "border-[#C1C1BD] bg-[#FFE6E6] text-brand-dark"
          ...
          >
            ...
            <div
              className={clsx(
                ...
                isLightTheme
                  ? "border-[#C1C1BD] bg-white/90 text-brand-dark/80"
