...
export default function Home() {
  ...
  return (
    <div
      ...
      style={{
        background: `radial-gradient(1100px 520px at 20% -18%, rgba(153,126,103,0.16) 0%, rgba(255,219,187,0) 56%), linear-gradient(180deg, ${background} 0%, ${background} 100%)`,
      }}
    >
      <div className="pointer-events-none absolute inset-0 bg-[linear-gradient(120deg,rgba(102,73,48,0.03)_0%,rgba(255,219,187,0)_42%,rgba(153,126,103,0.12)_100%)]" />

      <main className="relative mx-auto w-full max-w-md">
        <section
          className="mb-5 rounded-3xl border p-6"
          style={{
            borderColor: "rgba(153,126,103,0.32)",
            background: `linear-gradient(165deg, rgba(255,219,187,0.98) 0%, ${surface} 62%, rgba(153,126,103,0.14) 100%)`,
            boxShadow:
              "0 28px 70px -42px rgba(102,73,48,0.42), inset 0 1px 0 rgba(255,219,187,0.84), inset 0 -1px 0 rgba(153,126,103,0.12)",
          }}
        >
        ...
        {loadState === "loading" ? (
          <section
            ...
            style={{
              borderColor: "rgba(153,126,103,0.24)",
              background: "rgba(204,190,177,0.56)",
              color: text,
            }}
          >
        ...
        {loadState === "error" ? (
          <section
            ...
            style={{
              borderColor: "rgba(153,126,103,0.28)",
              background: "rgba(204,190,177,0.56)",
              color: text,
            }}
          >
              ...
              <div>
                ...
                <button
                  ...
                  style={{
                    borderColor: "rgba(153,126,103,0.32)",
                    color: text,
                    backgroundColor: "rgba(255,219,187,0.9)",
                  }}
        ...
        {loadState === "ready" && tables.length === 0 ? (
          <section
            ...
            style={{
              borderColor: "rgba(153,126,103,0.26)",
              background: "rgba(204,190,177,0.48)",
            }}
          >
            <div className="flex items-start gap-3">
            ...
            {tables.map((table) => {
              ...
              return (
                <Link
                  ...
                  style={{
                    borderColor: "rgba(153,126,103,0.3)",
                    background: `linear-gradient(160deg, rgba(255,219,187,0.98) 0%, ${surface} 70%, rgba(153,126,103,0.14) 100%)`,
                    boxShadow: "0 24px 58px -38px rgba(102,73,48,0.3), inset 0 1px 0 rgba(255,219,187,0.86), inset 0 -1px 0 rgba(153,126,103,0.16)",
                  }}
                >
                  <div className="flex items-center justify-between gap-3">
                    ...
                    <div
                      ...
                      style={{
                        borderColor: "rgba(153,126,103,0.32)",
                        backgroundColor: "rgba(153,126,103,0.2)",
                        color: text,
                      }}
                    >
                      Open
