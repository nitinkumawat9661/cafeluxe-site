...
export default function Home() {
  ...
  return (
    <div
      ...
      style={{
        background: `radial-gradient(1100px 520px at 20% -18%, rgba(89,0,28,0.16) 0%, rgba(255,230,230,0) 56%), linear-gradient(180deg, ${background} 0%, ${background} 100%)`,
      }}
    >
      <div className="pointer-events-none absolute inset-0 bg-[linear-gradient(120deg,rgba(13,18,22,0.03)_0%,rgba(255,230,230,0)_42%,rgba(89,0,28,0.12)_100%)]" />

      <main className="relative mx-auto w-full max-w-md">
        <section
          className="mb-5 rounded-3xl border p-6"
          style={{
            borderColor: "rgba(89,0,28,0.32)",
            background: `linear-gradient(165deg, rgba(255,230,230,0.98) 0%, ${surface} 62%, rgba(89,0,28,0.14) 100%)`,
            boxShadow:
              "0 28px 70px -42px rgba(13,18,22,0.42), inset 0 1px 0 rgba(255,230,230,0.84), inset 0 -1px 0 rgba(89,0,28,0.12)",
          }}
        >
        ...
        {loadState === "loading" ? (
          <section
            ...
            style={{
              borderColor: "rgba(89,0,28,0.24)",
              background: "rgba(193,193,189,0.56)",
              color: text,
            }}
          >
        ...
        {loadState === "ready" && tables.length === 0 ? (
          <section
            ...
            style={{
              borderColor: "rgba(89,0,28,0.26)",
              background: "rgba(193,193,189,0.48)",
            }}
          >
            <div className="flex items-start gap-3">
            ...
            {tables.map((table) => {
              ...
              return (
                <Link
                  ...
                  style={{
                    borderColor: "rgba(89,0,28,0.3)",
                    background: `linear-gradient(160deg, rgba(255,230,230,0.98) 0%, ${surface} 70%, rgba(89,0,28,0.14) 100%)`,
                    boxShadow: "0 24px 58px -38px rgba(13,18,22,0.3), inset 0 1px 0 rgba(255,230,230,0.86), inset 0 -1px 0 rgba(89,0,28,0.16)",
                  }}
                >
                  <div className="flex items-center justify-between gap-3">
                    ...
                    <div
                      ...
                      style={{
                        borderColor: "rgba(89,0,28,0.32)",
                        backgroundColor: "rgba(89,0,28,0.2)",
                        color: text,
                      }}
                    >
                      Open
